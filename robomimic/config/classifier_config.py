"""
Config for Classifier algorithm.
"""
...
class DistanceConfig(BaseConfig):
    ALGO_NAME = "distance"
...
class WeightContrastiveConfig(BaseConfig):
    ALGO_NAME = "weight_contrastive"
...
class TemporalEmbeddingConfig(BaseConfig):
    ALGO_NAME = "temporal_embedding"

    def train_config(self):
        super().train_config()
        self.train.radius = None #not used
    ...
    def algo_config(self):
        ...
        self.algo.optim_params.embedder.regularization.L2 = 0.00  # L2 regularization strength

        self.algo.optim_params.future.learning_rate.initial = 1e-4  # policy learning rate
        self.algo.optim_params.future.learning_rate.decay_factor = 0.1  # factor to decay LR by (if epoch schedule non-empty)
        self.algo.optim_params.future.learning_rate.epoch_schedule = []  # epochs where LR decay occurs
        self.algo.optim_params.future.regularization.L2 = 0.00  # L2 regularization strength
